package example.domain.example3;

import static example.domain.example3.Example3DetailEntity.toEntities;
import static example.domain.example3.Example3DetailEntity.toValueObjects;
