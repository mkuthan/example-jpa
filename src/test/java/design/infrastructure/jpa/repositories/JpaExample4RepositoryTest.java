...
import design.domain.example4.Example4Service;

@Test
public class JpaExample4RepositoryTest extends AbstractJpaRepositoryTest {
	...
	public void shouldCallAutowiredService() {
		// given
		String id = "any id";
		persistFlushAndClear(new Example4("any id"));
